                                  ...
                                  {Array.isArray(order.items) && order.items.length > 0 ? (
                                    <div className="bg-white rounded p-3 shadow-sm border border-gray-200">
                                      {order.items.map((item: any, i: number) => {
                                        ...
                                        return (
                                        <div key={item.id || i} className={`flex justify-between items-center text-sm border-b border-gray-100 py-2 last:border-0 last:pb-0 ${isMem ? 'opacity-40 bg-gray-50' : 'bg-green-50/50 rounded px-2 font-medium border-l-2 border-l-green-400 my-1'}`}>
                                          <div className="flex gap-3 items-center">
                                            ...
                                            <div>
                                              <p className="font-semibold text-gray-800">
                                                {item.title}
                                                {!isMem && <span className="ml-2 text-[10px] bg-green-100 text-green-700 px-1 rounded">Product to Ship</span>}
                                              </p>
